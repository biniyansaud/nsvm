 ...
 * -------------------------------
 * âœ… SUMMARY
 * - "map-attached" â†’ AdvancedMarkerElement, DirectionsRenderer, Layers.
 * - "standalone" â†’ Geocoder, DirectionsService, DistanceMatrixService, ElevationService.
 * - "data-only" â†’ Place, Geometry utilities.
 */
